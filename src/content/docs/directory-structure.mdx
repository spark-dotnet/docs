...
## Pages
The `Pages` directory contains your Razor pages and Razor components. This is where your sites frontend markdown and page logic will be contained. The inner `Shared` directory contains your re-usable Razor components and partials. This directory is only generated for Blazor and Razor Pages project types.
