...
HTMX is a javascript library that super charges your HTMX markup and allows you to do page navigation and form submissions with partial page reloads, giving your app a SPA like feel.
