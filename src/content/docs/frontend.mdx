...
## Introduction
Blazor Spark utilizes Blazor components to compose it's frontend markup and logic. Spark uses **Blazor Server** under the hood, so everything is rendered on the server.
