...
Spark also provides custom CLI [tool](/docs/spark-cli) to improve your developer experience. The Spark CLI helps you create new projects, migrations, services and other project files with ease. 
