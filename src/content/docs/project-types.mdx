...
Blazor projects utilize Razor components to split your markdown into re-usable components. These components also have the ability to contain logic specific to themselves.
