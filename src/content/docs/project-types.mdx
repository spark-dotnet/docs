...
Every project type comes with the same Spark functionality and services. The main differences is how their routes, markup, and markup logic is constructed.
...
To read more about Spark Blazor projects, check out our documentation [here](/blazor)
...
To read more about Spark MVC projects, check out our documentation [here](/mvc)
...
To read more about Spark Razor Pages projects, check out our documentation [here](/razor-pages)
