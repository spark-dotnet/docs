...
description: "Blazor Spark Razor Components"
---
...
You can pass data to a Razor component or page by using **Component Paramaters**.
...
Then, in a parent Razor component called `ParentComponent.razor`, you can render the child component and pass the `Title` parameter value.
```razor
<div>
...
```razor
<ChildComponent>
    Blazor Spark is <span class="text-yellow-600">Awesome!</span>
</ChildComponent>
```
