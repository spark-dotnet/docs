...
## Introduction
Spark provides a custom command line interface which is installed when installing the `BlazorSpark.Console` tool globally. See the [Installation page](/docs/installation) if you have not done this yet.
