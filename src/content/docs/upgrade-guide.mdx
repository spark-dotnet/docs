...
>
> Spark **0.4.0 has been deprecated** due to some bugs found after publishing. Please use 0.4.1+
>

Spark 0.4.0 came with breaking changes in the form of how it handles settings and .env variables.
