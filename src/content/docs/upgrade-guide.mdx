...
Projects before 0.6.0 referenced the `BlazorSpark.Library` Nuget package.

You can uninstall that Nuget and install Spark.Library.

The only other updates you will need to make is replace `using` statements throughout your project to reference the new Nuget namespace.
```csharp
// old
